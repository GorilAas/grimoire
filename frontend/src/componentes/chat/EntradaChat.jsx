    ...
    >
      ...
      <div className="max-w-[880px] mx-auto flex gap-2 overflow-x-auto pb-1 mb-2.5 sm:flex-wrap sm:overflow-visible">
        {sugestoes.map(s => (
          <button
            ...
            className="text-[12px] px-[11px] py-1.5 rounded-full border border-[var(--linha-suave)] bg-[var(--fundo-2)] text-[var(--texto-1)] transition-all duration-180 hover:border-musgo-400 hover:text-[var(--texto-0)] hover:bg-[var(--acento-suave)] whitespace-nowrap"
          >
            {s}
          </button>
        ))}
      ...
      >
        <textarea
          ...
          className="flex-1 min-w-0 bg-transparent border-0 outline-none resize-none min-h-[22px] max-h-[140px] text-[14px] text-[var(--texto-0)] placeholder:text-[var(--texto-3)] py-1 leading-[1.5]"
        />
